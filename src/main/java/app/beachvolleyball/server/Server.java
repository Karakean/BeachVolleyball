...
public class Server {
    ...
    public static final int GROUND_Y = 575;
    ...
    public static void main(String[] args) throws IOException {
        ...
        players[0] = new Player(1,(int)(0.25 * SCREEN_WIDTH - 50), GROUND_Y - PLAYER_HEIGHT);
        players[1] = new Player(2,(int)(0.75 * SCREEN_WIDTH), GROUND_Y - PLAYER_HEIGHT);
